...
if (isset($_POST['name']) && isset($_POST['email']) && isset($_POST['phone']) && isset($_POST['message'])){
    ...
    if(empty($_POST["name"])) {
        ...
        if(!preg_match("/^[a-zA-Z]*$/",$name)){
            $name_error = "Only letters and white space allowed"; //Should this be Only letters and NO white space allowed? But that brings up an even more important question, why no space allowed? Perhaps I need to change the preg_match
        }
    }
